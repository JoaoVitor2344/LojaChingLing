    ...
    public partial class FrmVenda : Form
    {
        ...
        private void FrmVenda_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "Localizar_VendaGrid";
        ...
        private void btnNovoItem_Click(object sender, EventArgs e)
        {
            ...
            cmd2.CommandText = "Localizar_VendaGrid";
        ...
        private void btnEditarItem_Click(object sender, EventArgs e)
        {
            ...
            dgvVenda.Rows[linha].Cells[5].Value = Convert.ToDecimal(txtQuantidade.Text) * Convert.ToDecimal(txtValor.Text);
            decimal soma = 0;
            foreach (DataGridViewRow dr in dgvVenda.Rows)
            {
                soma += Convert.ToDecimal(dr.Cells[5].Value);
        ...
        private void btnEcluirItem_Click(object sender, EventArgs e)
        {
            ...
            pedidos.ExecuteNonQuery();
            Conexao.fecharConexao();
            MessageBox.Show("Produto apagado", "Excluit produto", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvVenda.Refresh();
            decimal soma = 0;
            foreach (DataGridViewRow dr in dgvVenda.Rows)
            {
        ...
        private void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvVenda.Rows)
            {
                ...
                SqlCommand status = new SqlCommand("AtualizarStatusCartaoVenda2", con);
                status.CommandType = CommandType.StoredProcedure;
                status.Parameters.AddWithValue("@numero", num_cartao);
